...
const packet = new ServerEntityInspectionListingPacket(
    [
        new ComponentInfo("testComponent", "Test Component", "nobody", "a good component", 10000, "noIcon", [
        ...
        new ComponentInfo("testComponent2", "Test Component 2", "nobody else", "a gooder component", 10001, "noIcon", [
